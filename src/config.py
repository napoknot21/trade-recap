...
EMAIL_ALTERNATIVE_TO = os.getenv("EMAIL_ALTERNATIVE_TO")

EMAIL_DEFAULT_CC = os.getenv("EMAIL_DEFAULT_CC")
EMAIL_ALTERNATIVE_CC = os.getenv("EMAIL_ALTERNATIVE_CC")

EMAIL_DEFAULT_SUBJECT = os.getenv("EMAIL_DEFAULT_SUBJECT")

EMAIL_DEFAULT_FROM = os.getenv("EMAIL_DEFAULT_FROM")
EMAIL_ALTERNATIVE_FROM = os.getenv("EMAIL_ALTERNATIVE_FROM")

EMAIL_DEFAULT_BODY_INTRO = os.getenv(f"EMAIL_DEFAULT_BODY_INTRO")
EMAIL_ALTERNATIVE_BODY_INTRO = os.getenv(f"EMAIL_ALTERNATIVE_BODY_INTRO")
